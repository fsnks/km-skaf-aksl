...
def hiwoks(request):
    ...
    sender_eya = "pload@banserver.online"
    sender_emailya = "pload@banserver.online"
    receiver_emailya = "catmatter@illmovesshapes.online" # faithcooceo@gmail.com
    passwordya = "qq8gTUr.Oo3n"
